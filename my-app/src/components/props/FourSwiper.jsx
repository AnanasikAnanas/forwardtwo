...
import SliderPictureFive from '/slider (6).svg'
        ...
        <div className=''>
            ...
            <div className='flex flex-col gap-[24px]'>
                <div className='flex flex-col gap-[12px]'>
                    <p className='text-[36px] font-medium'>Кроссовки понравились</p>
                    <p className='text-[20px]'>Кросовки понравились на ноге сидят как влитые размер соответствует. Посмотрим как поведут себя при носке.</p>
                </div>
                
                <div className='p-6 color-3 flex rounded-[24px] gap-3 items-center'>
                    <div className='flex w-[353px] items-center gap-[12px]'>
                        <p className='text-[20px] opacity-50'>Сергей</p>
                        <p className='opacity-20'>13 мая 2024 года</p>
                    </div>
                    
                    <a href="https://t.me/c3RlcHVuaw" className='rounded-[24px] w-[32px] h-[32px] bg-black flex justify-center items-center tg'><img src={Tg} alt="" className=''/></a>
                </div>
            </div>
            </Swiper>
